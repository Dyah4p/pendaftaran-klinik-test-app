...
import KonfirmasiJanjiButton from '../../components/adminbutton/KonfirmasiJanjiButton'; // Impor komponen tombol
  ...
  return (
    <div className="konfirmasi-janji">
      ...
      <div className="main-content">
        ...
        <KonfirmasiJanjiButton janjiEdit={janjiEdit} tambahJanji={tambahJanji} updateJanji={updateJanji} />
